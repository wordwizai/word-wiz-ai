      ...
      >
        <CardHeader className="flex flex-col items-start gap-4 p-6">
          ...
          <div className="space-y-2">
            ...
            <Badge
              variant="secondary"
              className="px-3 py-1 text-sm font-semibold rounded-full bg-white/60 text-gray-700 border border-white/40 hover:bg-white/80 transition-colors duration-200"
            >
        ...
        <CardContent className="flex-1 text-left text-base leading-relaxed px-6 pb-4">
        ...
        <CardFooter className="flex justify-center pb-6">
          ...
          >
            <Button
              size="lg"
              variant="ghost"
              className="rounded-full w-16 h-16 p-0 flex items-center justify-center shadow-lg transition-all duration-300 transform-gpu bg-gradient-to-br from-white/80 via-white/90 to-white/80 hover:from-white hover:via-white hover:to-white border-2 border-white/60 hover:border-white/80 hover:shadow-xl"
