...
const LexiaRazKidsComparison = () => {
  ...
  const product1Details = {
    ...
    description: "Lexia Core5 is a comprehensive reading intervention program designed for schools. It excels at identifying struggling readers and providing systematic instruction across all reading areas. However, it's expensive and doesn't offer speech recognition technology.",
  };
  ...
  const product2Details = {
    ...
    description: "Raz-Kids provides a massive library of leveled books perfect for reading practice. It's affordable and engaging but assumes students can already decode. Best used as a supplement for fluency building, not primary phonics instruction.",
  };
  ...
  const wordWizDetails = {
    ...
    description: "Word Wiz AI is the only free option that listens to students read and provides specific pronunciation feedback. While it doesn't replace comprehensive intervention (Lexia) or reading practice (Raz-Kids), it fills a critical gap by addressing pronunciation—something neither competitor offers.",
  };

  const verdict = {
    product1: "Best for comprehensive reading intervention and assessment. Schools with budget for per-student licensing get detailed diagnostics and systematic instruction across all reading skills. Worth the investment if you need data-driven intervention.",
    product2: "Best for affordable reading practice with a large book library. At $3.33/student/year, it's perfect for building fluency and engagement. However, it doesn't teach phonics or provide pronunciation feedback.",
    wordWiz: "Best for pronunciation feedback and speech technology. It's the only completely free option and the ONLY tool among these three that actually listens to students read. Perfect as a supplement to either Lexia or Raz-Kids, or as a standalone tool for budget-conscious educators.",
  ...
  const faqs = [
    {
      ...
      answer: "They serve different purposes. Lexia excels at intervention and assessment with comprehensive diagnostic data. Raz-Kids excels at providing reading practice with a large book library. Word Wiz AI excels at pronunciation feedback with speech recognition. Most schools use multiple programs together rather than choosing just one.",
    },
    {
      question: "Can I buy Lexia for home use?",
      answer: "No, Lexia Core5 is only available for schools and districts. For home use, consider Word Wiz AI (100% free with speech recognition) or other parent-friendly programs like Reading Eggs or Hooked on Phonics.",
    },
    {
      question: "Does Raz-Kids teach phonics?",
      answer: "No, Raz-Kids assumes students can already decode and focuses on reading practice with leveled books. For phonics instruction with pronunciation feedback, use Word Wiz AI. For systematic phonics curriculum, consider Lexia or programs like Reading Eggs.",
    },
    {
      question: "Which program is best for struggling readers?",
      answer: "Lexia excels at identifying and supporting struggling readers with its comprehensive assessment system. However, if pronunciation is the main issue, Word Wiz AI is the only option with speech recognition to identify and correct specific pronunciation errors. Consider using both together.",
    },
    {
      question: "Is Word Wiz AI really completely free?",
      answer: "Yes, all core features including speech recognition, pronunciation feedback, unlimited practice, and teacher dashboard are 100% free with no per-student costs, subscriptions, or hidden fees. This makes it accessible for any school or family regardless of budget.",
    },
    {
      question: "Can I use these programs together?",
      answer: "Absolutely! Many schools use combinations: Lexia for assessment and intervention + Word Wiz AI for pronunciation feedback, or Raz-Kids for reading practice + Word Wiz AI for pronunciation correction. These tools complement rather than compete with each other.",
    },
  ];
  ...
  const structuredData = {
    ...
    "description": "Compare Lexia Core5, Raz-Kids, and Word Wiz AI reading programs for schools. See pricing, features, and which is best for your classroom.",
    "mainEntity": [
      {
        "@type": "Product",
      ...
      },
      {
        "@type": "Product",
        "name": "Word Wiz AI",
        "description": "Free AI-powered pronunciation feedback with speech recognition",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD"
