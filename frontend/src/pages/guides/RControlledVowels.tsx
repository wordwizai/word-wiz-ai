...
const RControlledVowels = () => {
  const content: ArticleSection[] = [
    ...
    },
    {
      type: "paragraph",
      content:
        'R-controlled vowels (also called "Bossy R" or "vowel-R combinations") occur when the letter R follows a vowel and changes how that vowel sounds. Instead of saying the vowel\'s typical short or long sound, the R "takes over" and creates a completely different sound.',
    },
    {
      type: "paragraph",
      content:
        'For example, the word "cat" has a short A sound (/æ/). But when you add an R after the A to make "car," that same A vowel now sounds completely different (/ar/). The R has "bossed" the vowel into a new sound.',
    },
    {
      type: "callout",
      content: {
        ...
        title: 'Why "Bossy R"?',
        content:
          "Teachers call these patterns \"Bossy R\" because the R is so strong it completely controls what sound the vowel makes. It's a kid-friendly way to explain why the vowel doesn't sound like usual.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      content:
        "There are five main r-controlled vowel combinations, but here's the surprising part: three of them sound exactly the same! Let's break them down:",
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        'The AR combination makes the sound you hear in "car" or "start." This is one of the most distinct r-controlled sounds, and it\'s usually easier for kids to recognize and remember.',
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        'The OR combination makes the sound in "for" or "sport." This is the second most distinct sound and relatively easy for children to master.',
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        'Here\'s where it gets tricky: ER, IR, and UR all make exactly the same sound—the one you hear in "her," "bird," and "fur." They\'re pronounced identically, which means spelling becomes a memorization challenge.',
    },
    {
      type: "callout",
      content: {
        ...
        content:
          'Because these three patterns sound identical, children can decode them easily but will struggle with spelling them correctly. When writing, they must memorize which pattern each word uses—there\'s no way to "sound it out" to know if "bird" uses IR instead of ER or UR.',
      },
    },
    {
      type: "paragraph",
      content:
        "**ER words:** her, fern, term, verb, perch, clerk, herd, person, better, sister",
    },
    {
      type: "paragraph",
      content:
        "**IR words:** sir, fir, bird, girl, dirt, first, third, shirt, skirt, circus",
    },
    {
      type: "paragraph",
      content:
        "**UR words:** fur, burn, turn, hurt, curl, purse, nurse, turtle, purple, burden",
    },
    {
      type: "heading",
      level: 2,
    ...
    },
    {
      type: "paragraph",
      content:
        "Timing matters. R-controlled vowels should be taught after your child has mastered:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        "Start with these two patterns because they have distinct, recognizable sounds that don't overlap with other patterns. Teach them one at a time, spending 3-5 days on each before moving forward.",
    },
    {
      type: "paragraph",
      content:
        '**For AR:** Show your child how the letter R changes the A sound. Say "cat" then "car" slowly, emphasizing how different the vowel sound becomes when R is added.',
    },
    {
      type: "paragraph",
      content:
        '**For OR:** Do the same comparison—"not" vs "north," "top" vs "torn." Help them hear how the R changes everything.',
    },
    {
      type: "callout",
      content: {
        ...
        content:
          "Have your child make an 'AR' pirate sound (ARRR!) when they see AR words, and pretend to roar like a lion for OR words. Physical associations help cement the patterns in memory.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      content:
        "After AR and OR are solid, introduce all three of these together. Explain upfront that they sound the same but look different—this prevents confusion and frustration.",
    },
    {
      type: "paragraph",
      content:
        "Say something like: \"These three patterns are tricky twins... well, actually triplets! ER, IR, and UR all make the exact same sound. When you're reading, that's easy—you just say the same sound. But when you're spelling, you'll need to remember which one each word uses.\"",
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        "Once your child can identify the patterns, move to reading practice. Start with word lists, then simple sentences, then short decodable stories that feature r-controlled vowels heavily.",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "paragraph",
      content:
        "Create word families within each pattern to show how changing the initial consonant keeps the same r-controlled vowel pattern:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        "Say words aloud and have your child identify which sound they hear: AR, OR, or the ER/IR/UR sound. This builds phonemic awareness for r-controlled patterns.",
    },
    {
      type: "paragraph",
      content:
        "Words to use: bark, corn, shirt, start, purple, born, market, nurse, morning, dirt, garden, clerk, sport",
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        "Create silly sentences that use multiple r-controlled words. Kids love the absurdity, and repetition helps learning:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        "Make bingo cards with r-controlled words. Call out words and have your child find them on their board. This combines visual recognition with auditory processing.",
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        "Go on a hunt around your house or outside to find objects with r-controlled vowel names: jar, fork, door, shirt, stroller, garden, etc. Say the word, identify the r-controlled pattern, and even write them down.",
    },
    {
      type: "heading",
      level: 2,
    ...
    },
    {
      type: "paragraph",
      content:
        'Some kids will try to say the short vowel sound first, then add the R sound: "c-a-r" sounds like "kah-ruh" instead of "car." Remind them that AR is one blended sound, not two separate sounds.',
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        'If your child reads "for" as "fur," they\'re mixing up the sounds. Practice comparing: say both words back-to-back so they can hear the difference clearly.',
    },
    {
      type: "heading",
      level: 3,
    ...
    },
    {
      type: "paragraph",
      content:
        "This is completely normal! Since these sound identical, spelling errors are expected. Create a personal list of tricky words your child misspells often and practice those specifically. Common problem words: girl (not gerl), her (not hur), bird (not berd).",
    },
    {
      type: "callout",
      content: {
        ...
        content:
          "Remember: your child should be able to READ r-controlled vowel words fairly easily once they understand the patterns. SPELLING them correctly (especially ER/IR/UR) takes much longer and requires memorization. Don't let spelling struggles hold back reading progress.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      content:
        "R-controlled vowels require precise pronunciation, which is where Word Wiz AI excels. Our platform provides:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        "Your child has mastered r-controlled vowels when they can consistently:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      type: "paragraph",
      content:
        "Once your child has solid command of r-controlled vowels, they're ready for:",
    },
    {
      type: "list",
      content: [
    ...
    },
    {
      ...
      content: {
        ...
        content:
          "Mastering r-controlled vowels means your child is progressing beyond beginning reading skills. They're developing the phonics knowledge needed to tackle increasingly complex texts with confidence.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      content:
        "R-controlled vowels are a major phonics milestone. With consistent practice and the right strategies, your child will master them and unlock hundreds of new words they can confidently read. You've got this!",
    },
  ];
